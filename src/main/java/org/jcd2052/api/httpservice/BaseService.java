...
public abstract class BaseService {
    public Response sendRequestAndRecieveResponse(RequestSpecification requestSpecification) {
        ...
        AqualityServices.getLogger().info(String.format(message, getMethod().toString(),
        ...
        AqualityServices.getLogger().info(String.format("Request has been performed for %f seconds.",
                timeResult));
        return response;
    }
